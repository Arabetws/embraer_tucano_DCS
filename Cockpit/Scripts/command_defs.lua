...
device_commands =
{
    ...
    -- T-27
    ElecBattTempTest                    = __counter(),
    ElecBattVoltTest                    = __counter(),

    CabinTemp                           = __counter(),
    CabinHeater                         = __counter(),
    CabinExternal                       = __counter(),
    CabinCond                           = __counter(),
    ACMain                              = __counter(),
    ACBackup                            = __counter(),
    IntLightPnl                         = __counter(),
    IntLightPnlOnOff                    = __counter(),
    IntLightStorm                       = __counter(),
    IntLightAlmBright                   = __counter(),
    
    FuelLeftMain                        = __counter(),
    FuelRightMain                       = __counter(),
    FuelLeftAux                         = __counter(),
    FuelRightAux                        = __counter(),
    FuelLeftXfr                         = __counter(),
    FuelRightXfr                        = __counter(),
    FuelLeftMainStTest                  = __counter(),
    FuelRightMainStTest                 = __counter(),
    FuelLeftMainStBright                = __counter(),
    FuelRightMainStBright               = __counter(),
    FuelLeftAuxStTest                   = __counter(),
    FuelRightAuxStTest                  = __counter(),
    FuelLeftAuxStBright                 = __counter(),
    FuelRightAuxStBright                = __counter(),
    FuelLeftXfrStTest                   = __counter(),
    FuelRightXfrStTest                  = __counter(),
    FuelLeftXfrStBright                 = __counter(),
    FuelRightXfrStBright                = __counter(),
    RadioVHF1OnOff                      = __counter(),
    RadioVHF2OnOff                      = __counter(),
    RadioOnOff                          = __counter(),
    RadioNAVOnOff                       = __counter(),
    RadioMKROnOff                       = __counter(),
    RadioDMEOnOff                       = __counter(),
    RadioADFOnOff                       = __counter(),
    RadioEmer                           = __counter(),
    RadioVolume                         = __counter(),
    RadioMKRHiLo                        = __counter(),
    RadioCallHC                         = __counter(),
    CrtlXfrRadioADF                     = __counter(),
    CrtlXfrRadioVHF1                    = __counter(),
    CrtlXfrRadioDME                     = __counter(),
    CrtlXfrRadioTDR                     = __counter(),
    CrtlXfrRadioVHF2                    = __counter(),
    CrtlXfrRadioNAV                     = __counter(),
    RadioATCFreq                        = __counter(),
    RadioATCFreqTest                    = __counter(),
    RadioATCFreqLarge                   = __counter(),
    RadioATCModeSmall                   = __counter(),
    RadioATCModeSmallPress              = __counter(),
    RadioATCModeLarge                   = __counter(),
    RadioATCIdent                       = __counter(),
    MaxSpeedTest                        = __counter(),
    PictorialNavSinc                    = __counter(),
    PictorialNavCoup                    = __counter(),
    Sight                               = __counter(),
    Pedals                              = __counter(),
    EmerParkBrake                       = __counter(),
    RadioCOM1Freq                       = __counter(),
    RadioCOM1FreqPress                  = __counter(),
    RadioCOM1FreqLarge                  = __counter(),
    RadioCOM1ModeSmall                  = __counter(),
    RadioCOM1ModeSmallPress             = __counter(),
    RadioCOM1ModeLarge                  = __counter(),
    RadioCOM1Tune                       = __counter(),
    RadioCOM1Sel                        = __counter(),
    RadioCOM2Freq                       = __counter(),
    RadioCOM2FreqPress                  = __counter(),
    RadioCOM2FreqLarge                  = __counter(),
    RadioCOM2ModeSmall                  = __counter(),
    RadioCOM2ModeSmallPress             = __counter(),
    RadioCOM2ModeLarge                  = __counter(),
    RadioCOM2Tune                       = __counter(),
    RadioCOM2Sel                        = __counter(),
    RadioNAVFreq                        = __counter(),
    RadioNAVFreqPress                   = __counter(),
    RadioNAVFreqLarge                   = __counter(),
    RadioNAVModeSmall                   = __counter(),
    RadioNAVModeSmallPress              = __counter(),
    RadioNAVModeLarge                   = __counter(),
    RadioNAVTune                        = __counter(),
    RadioNAVSel                         = __counter(),
    RadioADFFreq                        = __counter(),
    RadioADFFreqPress                   = __counter(),
    RadioADFFreqLarge                   = __counter(),
    RadioADFModeSmall                   = __counter(),
    RadioADFModeSmallPress              = __counter(),
    RadioADFModeLarge                   = __counter(),
    RadioADFTune                        = __counter(),
    RadioADFSel                         = __counter(),
    LndGearDoorsTest                    = __counter(),
    LndGearDoorsBright                  = __counter(),
    LndGearRightTest                    = __counter(),
    LndGearRightBright                  = __counter(),
    LndGearLeftTest                     = __counter(),
    LndGearLeftBright                   = __counter(),
    LndGearNoseTest                     = __counter(),
    LndGearNoseBright                   = __counter(),
    LndGearEmerUp                       = __counter(),
    LndGear                             = __counter(),
    EltOn                               = __counter(),
    TotOn                               = __counter(),
    ClockStart                          = __counter(),
    ClockRotate                         = __counter(),
    IASSet                              = __counter(),
    AccelSet                            = __counter(),
    ADIAdjustPress                      = __counter(),
    ADIAdjustRotate                     = __counter(),
    ADIAdjustBkpPress                   = __counter(),
    ADIAdjustBkpRotate                  = __counter(),
    AltimeterPressure                   = __counter(),
    HSIHeading                          = __counter(),
    HSICourse                           = __counter(),
    EmerBat                             = __counter(),
    EmerBatTest                         = __counter(),
    EmerBatBright                       = __counter(),
    IntermTest                          = __counter(),
    IntermBright                        = __counter(),
    ExternalTest                        = __counter(),
    ExternalBright                      = __counter(),
    AirwayTest                          = __counter(),
    AirwayBright                        = __counter(),
    Beep                                = __counter(),
    FireTest                            = __counter(),
    MOCGuard                            = __counter(),
    MOCAdjust                           = __counter(),
