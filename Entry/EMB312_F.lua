...
EMB312FFM = {
	Name                                     = EMB312F,
	DisplayName                              = _('Embraer EMB-312F Tucano (France)'),
	HumanCockpit                             = true,
	...
	SFM_Data                                 =
	{
		...
		engine =
		{
			...
			table_data            =
			{
				...
				[2] = { 0.1, 20500.0, 20500.0 },
				[3] = { 0.2, 15000.0, 15000.0 },
				[4] = { 0.3, 12000.0, 12000.0 },
				[5] = { 0.4, 8100.5, 8100.5 },
				[6] = { 0.5, 6500.0, 6500.0 },
				[7] = { 0.6, 4800.5, 4800.5 },
				[8] = { 0.7, 4500.0, 4500.0 },
	...
	AddPropAircraft                          = {
		...
		{ id = "PilotHelmet" , control = 'comboList', label = _('Pilot helmet customization'),
          values = {{id =  0, dispName = _("helmet 1"), value = 0.5},
                    {id =  1, dispName = _("helmet 2"), value = 0.8},
                    {id =  2, dispName = _("helmet 3"), value = 0.85},},
          defValue  = 0,
          wCtrl     = 150,
          arg = 810,
        },

		{ id = "PilotHelmetVisor" , control = 'comboList', label = _('Pilot helmet Visor 1'),
			playerOnly = false,
			defValue  = 1,
			arg = 811, 
			wCtrl     = 150,
		...
		{ id = "PilotHelmetVisor2" , control = 'comboList', label = _('Pilot helmet Visor 2'),
			playerOnly = false,
			defValue  = 0,
			arg = 812, 
			wCtrl     = 150,
		...
		{ id = "InstructorHelmetVisor2" , control = 'comboList', label = _('Instructor helmet Visor 2'),
			playerOnly = false,
			defValue  = 0,
			arg = 816, 
			wCtrl     = 150,
