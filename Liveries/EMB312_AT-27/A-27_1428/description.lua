livery = {
	...
	{"AT27", ROUGHNESS_METALLIC ,"Camu_AT-27_Fuselage_RoughMet",true};
	
	{"AT27PARTS", DIFFUSE, "cinza_a29b_parts", true};
	...
	{"AT27_PILOT",	DIFFUSE			,	"AT_Pilot_AL", true};
...
name = "AT-27 1428 2º/º3 Grupo de Aviação"
countries = {}
custom_args =
{
