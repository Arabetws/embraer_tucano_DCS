livery = {
	...
	{ "AT27",         NORMAL_MAP,            "F_AT-27_Fuselage_NM",       true },
	{ "AT27",         ROUGHNESS_METALLIC,    "F_AT-27_Fuselage_RoughMet", true },

	{ "AT27PARTS",    DIFFUSE,               "w_a29b_parts",              true },
...
name = "EMB-312F 438 312-UW"
countries = {}
custom_args =
{
	[810] = 0.6, -- Pilot helmet
	[811] = 1, -- Helmet visor 0-close, 1-open
	[812] = 0, -- Front helmet visor 0-close, 1-open
	[813] = 0, -- 0: colete, 1: no colete

	[814] = 0.6, -- Pilot helmet
	[815] = 0, -- Helmet visor 0-close, 1-open
	[816] = 1, -- Front helmet visor 0-close, 1-open
	[817] = 0, -- 0: colete, 1: no coletee
